...
describe ('API: generate', () => {
    ...
    it ('should return isDynamicEntry for dynamically imported modules', async () => {
        ...
        expect(main1.code.indexOf(`'${path.resolve(process.cwd(), './src/dynamic.js').replace(/\\/g, '\\\\')}': '/chunk-dynamic-[hash].js'`) > -1).to.be.true;
        expect(Object.keys(main1.modules).length).to.equal(1);
        expect(main1.modules[path.resolve(process.cwd(), './src/main1.js')]).not.to.be.undefined;
        ...
        expect(main2.code.indexOf(`'${path.resolve(process.cwd(), './src/dynamic.js').replace(/\\/g, '\\\\')}': '/chunk-dynamic-[hash].js'`) > -1).to.be.true;
        expect(Object.keys(main2.modules).length).to.equal(1);
        expect(main2.modules[path.resolve(process.cwd(), './src/main2.js')]).not.to.be.undefined;
        ...
        expect(main1.code.indexOf(`'${path.resolve(process.cwd(), './src/subdynamic.js').replace(/\\/g, '\\\\')}': '/chunk-subdynamic-[hash].js'`) > -1).to.be.true;
        expect(main2.code.indexOf(`'${path.resolve(process.cwd(), './src/subdynamic.js').replace(/\\/g, '\\\\')}': '/chunk-subdynamic-[hash].js'`) > -1).to.be.true;      
        expect(dynamic.code.indexOf(`'${path.resolve(process.cwd(), './src/subdynamic.js').replace(/\\/g, '\\\\')}': '/chunk-subdynamic-[hash].js'`) === -1).to.be.true;        
