...
module.exports = {
    ...
    invalidate (context, filePath) {
        ...
        // FIXME needs to normalize path for symlinked projects
    ...
    setOutputOptions (context, outputOptions) {
        // FIXME assign options
        //
        // In dev-middleware, configs[i].output.dir is used.
        //
        // configs[i].output is cached before outputOptions hook is run, but
        // outputOptions hook is allowed to override outputOptions.
        //
        // So configs[i].output must be mutated by the hook...
        //
        Object.assign(outputOptions, callOutputOptionsHook(context, outputOptions))
