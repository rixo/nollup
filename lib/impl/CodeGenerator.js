...
async function generateChunk (context, chunk, bundle, dynamicImports) {
    ...
    if (chunk.isDynamicEntry) {
        ...
        `   var __nollup__import__meta__ = {
            ...
            ${(chunk.exports.length > 0 && context.output.format === 'esm')? 'var __nollup_entry_exports = ' : ''}(function (modules, __nollup__global__) {
        ...
        ${context.output.format === 'esm'? chunk.exports.map(declaration => {
