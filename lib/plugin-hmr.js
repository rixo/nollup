    ...
    return {
        nollupBundleInit () {
            return `
                ...
                function setCompileError (compileError) {
                    verboseLog('Compile Error', compileError);
                    window.__hot.compileError = compileError;
                    window.__hot.errorHandlers.forEach(function (handler) {
                        handler(compileError);
                    });
                }

                function addErrorHandler (callback) {
                    window.__hot.errorHandlers.push(callback);
                }
