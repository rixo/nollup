        ...
        nollupBundleInit () {
            return `
                ...
                function getDiposableAcceptableModules (id) {
                    ...
                    var disposable = [];
                    var acceptable = [];
                    var acceptable_branches = {};

                    if (instances[id] && instances[id].hot._accept) {
                        acceptable.push(id);
                        disposable.push(id);
                        acceptable_branches[id] = [id];
                    }
                        ...
                        var checkForAcceptable = function (branch) {
                            ...
                            if (instances[latest].hot._accept) {
                                if (acceptable.indexOf(latest) === -1) {
                                    ...
                                    acceptable_branches[latest] = branch.slice(0);
                                }
                    ...
                    return { acceptable: acceptable, disposable: disposable, acceptable_branches: acceptable_branches };
                }
                        ...
                        if (hot.changes) {
                            ...
                            hot.changes.forEach(function (change) {
                                ...
                                if (!change.removed) {
                                    ...
                                    hmrAcceptCallback(mods.acceptable, mods.acceptable_branches);
                                }
                            });
